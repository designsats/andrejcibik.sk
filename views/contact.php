	...
	<div class="growImg awards-section" style="background-image: url(data/me03.jpg);">
		...
		<div class="row ease-item ease-left">
			<div class="small-6 medium-4 large-3 large-offset-1">
				...
				<br>
				<a href="http://www.cssawds.com/nominee/andrej-cibik/" class="item" target="_blank"><strong>CSSawds</strong> - nominee</a>
				<br>
			</div>
		</div>
		...
		<a href="http://www.cssawds.com/website/AddYourFeatureLinkHere"  class="cssa" target="_blank"></a>
