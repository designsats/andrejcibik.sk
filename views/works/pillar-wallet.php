...
<script type="text/javascript">
	$(function(){
		...
		// Title change
			document.title = 'Pillar wallet concept' + ' ' + defaultTitle;
...
<h1 class="centered">Pillar wallet
	<span class="ghost-title">Concept</span>
</h1>

<div class="centered">
	<span class="project-detail"><strong>ROLE:</strong> Designer</span>
	<span class="project-detail"><strong>DATE:</strong> September 2017</span>
	<span class="project-detail"><strong>CONTEXT:</strong> App design</span>
</div>
...
<div class="section">
	<div class="growImg" style="background-image: url(data/projects/pillar/01.jpg);">
...
<div class="centered boxed ease-item ease-bottom">
	<div class="videoWrapper">
		<iframe src="https://player.vimeo.com/video/234048364?color=128ccd&title=0&byline=0&portrait=0" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
	</div>
</div>
...
<div class="centered boxed ease-item ease-bottom">
	<img src="data/projects/pillar/01.png" class="respImg" alt="">
</div>
...
<div class="centered boxed ease-item ease-bottom">
	<img src="data/projects/pillar/02.png" class="respImg" alt="Pillar user flow">
</div>

<div class="separator"></div>

<div class="section">
	<div class="growImg" style="background-image: url(data/projects/pillar/02.jpg);">
		<div class="growSide growSide-left"></div>
		<div class="growSide growSide-right"></div>
	</div>
</div>
...
<div class="centered ease-item ease-bottom">
	<img src="data/projects/pillar/03.png" class="respImg" alt="Home screen">
</div>
...
<div class="centered ease-item ease-bottom">
	<img src="data/projects/pillar/04.png" class="respImg" alt="Receive and send">
</div>
...
<div class="centered boxed ease-item ease-bottom">
	<iframe src="https://marvelapp.com/ja31cbg?emb=1" width="300" height="700" allowTransparency="true" frameborder="0"></iframe>
</div>
...
<div class="centered ease-item ease-bottom">
	<img src="data/projects/pillar/06.png" class="respImg" alt="Dark version">
</div>
...
<div class="centered ease-item ease-bottom">
	<img src="data/projects/pillar/07.png" class="respImg" alt="Onboarding">
</div>
...
<div class="centered ease-item ease-bottom">
	<img src="data/projects/pillar/08.png" class="respImg" alt="Multicurrency">
</div>
...
<div class="row ease-item ease-left">
	<div class="small-6 medium-4 large-3 large-offset-1">
		<h3>Different themes and menu style</h3>
...
<div class="centered ease-item ease-bottom">
	<img src="data/projects/pillar/09.png" class="respImg" alt="">
</div>
...
<div class="boxed ease-item ease-bottom next-project-cont multiple">
	<a href="logos-2016" class="button rippleHover prevProject"><span class="arrow"></span> Prev project</a>
